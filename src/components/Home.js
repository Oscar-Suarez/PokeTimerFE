...
function Home() {
    return (
      ...
      <div className={styles.intcir}></div>
      </div>
        ...
        <div className={styles.contSec}>
          <div className={styles.contTer}>      <p className={styles.p}>Dentro de este timer podras conseguir diversos Pokémon a medida que pasa el tiempo</p>
        ...
        <p className={styles.p}>Las recompensas y los tiempos están multiplicados al 1000%, lo cual quiere decir que la aplicación final no funcionará con esos tiempos ni recompensas; esto está modificado para que puedas ver la funcionalidad de todo dentro del PokeTimer.</p>
        <p className={styles.p}>Considere por favor que debido a que es una versión inicial, al momento de salir de la página o volver a cargar la página, todos sus datos se podrán perder.</p></div>
        </div>
      </div>
